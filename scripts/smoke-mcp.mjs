...
const client = new Client({ name: "agentvegan-smoke", version: "2.0.0" });
...
process.stdout.write("MCP SDK v2 : 9 outils publics, AgentVegan Kitchen et toutes les étapes illustrées vérifiés.\n");
