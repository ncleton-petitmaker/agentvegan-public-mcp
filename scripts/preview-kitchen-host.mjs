...
const mcpClient = new Client({ name: "agentvegan-visual-proof", version: "2.0.15" });
...
<body>
  <main class="host">
    <header class="bar"><div><strong>Validation réelle · Agent Vegan 2.0.15</strong><div class="hint">Données chargées depuis mcp.agentvegan.org</div></div><span id="status" class="status">Connexion au bridge…</span></header>
      ...
      try {
        if (message.method === "ui/initialize") {
          send({ jsonrpc: "2.0", id: message.id, result: {
            ...
            hostInfo: { name: "agentvegan-visual-proof", version: "2.0.15" },
            hostCapabilities: {
              openLinks: {},
              serverTools: {},
